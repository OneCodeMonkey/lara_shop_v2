...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::get('paymenet/{order}/alipay', 'PaymentController@payByAlipay')->name('payment.alipay');
    Route::get('payment/alipay/return', 'PaymentController@alipayReturn')->name('payment.alipay.return');
    Route::get('paymenet/{order}/wechat', 'PaymentController@payByWechat')->name('payment.wechat');
    Route::get('payment/{order}/installment', 'PaymentController@payByInstallment')->name('payment.installment');
