        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="installment-top">
                    <div class="installment-info">
                        <div class="line">
                            ...
                            <div class="line-value">
                                <a target="_blank" href="{{ route('orders.show', ['order' => $installment->order_id]) }}">
                                    查看
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="installment-next text-right">
                        ...
                        <div class="payment-buttons">
                            <a class="btn btn-primary btn-sm" href="{{ route('installment.alipay', ['installment' => $installment->id]) }}">支付宝支付</a>
                ...
                <table class="table">
                    ...
                    <tr>
                        <td>{{ $item->response + 1 }} / {{ $installment->count }} 期</td>
