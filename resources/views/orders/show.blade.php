            ...
            <div class="card-body">
                ...
                <div class="order-botton">
                    ...
                    <div class="order-summary text-right">
                        ...
                        @endif
                        <!-- 支付按钮结束 -->
                        <!-- 如果订单的发货状态为已发货，则展示【确认收货】按钮 -->
                        @if($order->ship_status === \App\Models\Order::SHIP_STATUS_DELIVERED)
                        <div class="receive-button">
                            <button type="button" id="btn-receive" class="btn btn-sm btn-success">确认收获</button>
                        </div>
                        @endif

                        <!-- 不是众筹订单，已支付，且退款状态是未退款的时候，展示【申请退款】按钮 -->
            ...
            <div class="modal-body">
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tr>
                        ...
                        <td>{{ $rate }}%</td>
                        <td>
                            <button class="btn btn-sm btn-primary btn-select-installment" data-count="{{ $count }}">
                                选择
                            </button>
                        </td>
                    </tr>
...
<script>
    $(document).ready(function () {
        ...
        $('#btn-wechat').click(function () {
            swal({
                // content 参数可以是一个 DOM 元素，这里我们用 jQuery 动态生成一个 <img> 标签，并通过 [][index] 方式获取到此 DOM 元素
